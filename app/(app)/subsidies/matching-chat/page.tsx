...
const MatchingChatPage: React.FC = () => { // コンポーネント名を変更 (例: MatchingChatPage)
  ...
  const [companyInfo, setCompanyInfo] = useState<CompanyInfo>({ // 型を明示
    name: "株式会社テクノソリューション",
    industry: "IT・通信",
    employees: "25名",
  });
  ...
  const handleSendMessage = () => {
    ...
    const newUserMessage: Message = { // 型を明示
    ...
    setTimeout(() => {
      ...
      if (option === "製造業" || option === "IT・通信") {
          aiResponses.push({
              ...
              options: ["10名未満", "10〜30名", "31〜50名", "51〜100名", "101名以上"],
          });
          newProgress = 30;
  ...
  const grantsData: Grant[] = [ // 型を明示し、変数名を変更
    {
      id: 1,
      name: "IT導入補助金2025",
    ...
    <div className="flex flex-col h-[calc(100vh-theme(spacing.16)-theme(spacing.12))] bg-gray-50 font-sans">
      ...
      <header className="bg-white shadow-sm h-16 flex items-center px-6 sticky top-0 z-10">
        <div className="flex items-center justify-between w-full">
          <div className="text-2xl font-bold text-primary">補助金AIチャット</div> {/* HeroUIのカラーを使用 */}
          <div className="flex items-center space-x-2 bg-primary-50 px-4 py-2 rounded-lg"> {/* HeroUIのカラーを使用 */}
            <div className="text-sm text-foreground-600">会社情報:</div> {/* HeroUIのカラーを使用 */}
            <div className="text-sm font-medium text-foreground-800">{companyInfo.name}</div> {/* HeroUIのカラーを使用 */}
            <div className="text-xs bg-secondary-100 text-secondary-800 px-2 py-1 rounded-md"> {/* HeroUIのカラーを使用 */}
          ...
          <button className="bg-danger hover:bg-danger-600 text-white px-4 py-2 rounded-md whitespace-nowrap cursor-pointer flex items-center"> {/* HeroUIのカラーとButtonコンポーネント推奨 */}
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* チャットエリア */}
        <div className="w-8/12 flex flex-col bg-background border-r border-divider"> {/* HeroUIのカラーを使用 */}
          <div className="p-4 bg-content1 border-b border-divider"> {/* HeroUIのカラーを使用 */}
          ...
          {/* 入力エリア */}
          <div className="p-4 border-t border-divider bg-background"> {/* HeroUIのカラー */}
        ...
        {/* サイドパネル */}
        <div className="w-4/12 bg-content1 flex flex-col"> {/* HeroUIのカラー */}
          <div className="p-4 bg-background border-b border-divider"> {/* HeroUIのカラー */}
            <h2 className="text-lg font-semibold text-foreground">
              ヒアリング進捗
            </h2>
            <div className="mt-2">
              <div className="w-full bg-default-200 rounded-full h-2.5"> {/* HeroUIのカラー */}
                <div
          ...
          <div className="flex-1 overflow-y-auto p-4">
            ...
            <div className="space-y-4">
              {grantsData.map((grant) => ( // grants -> grantsData
                <div
                  key={grant.id}
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <div className="bg-success-100 text-success-800 text-xs px-2 py-1 rounded-full"> {/* HeroUIのカラー */}
                  ...
                  <div className="flex justify-between items-center mt-3">
                    <div className="text-xs text-danger-600"> {/* HeroUIのカラー */}
            ...
            <div className="mt-6">
              <button className="w-full bg-default-100 hover:bg-default-200 text-foreground-700 font-medium py-2 px-4 rounded-md border border-default-300 whitespace-nowrap cursor-pointer"> {/* HeroUIのButton推奨 */}
          ...
          <div className="p-4 bg-background border-t border-divider"> {/* HeroUIのカラー */}
            ...
            >
              <button className="w-full bg-success hover:bg-success-600 text-success-foreground font-medium py-3 px-4 rounded-md whitespace-nowrap cursor-pointer"> {/* HeroUIのButton推奨 */}
          ...
          <div className="bg-background rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="p-6 overflow-y-auto flex-1">
              <div className="mb-6">
                ...
                <p className="text-foreground-700">{selectedGrant.description}</p>
              </div>
