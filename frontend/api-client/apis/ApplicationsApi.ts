...
export class ApplicationsApi extends runtime.BaseAPI {
   ...
   */
  async applicationsIdGetRaw(
    requestParameters: ApplicationsIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * Get application details
   */
  async applicationsIdGet(
    requestParameters: ApplicationsIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Application> {
    const response = await this.applicationsIdGetRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async applicationsIdPutRaw(
    requestParameters: ApplicationsIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Application>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: ApplicationUpdateRequestToJSON(
   ...
   * Update application (e.g., status/progress)
   */
  async applicationsIdPut(
    requestParameters: ApplicationsIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Application> {
    const response = await this.applicationsIdPutRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async applicationsPostRaw(
    requestParameters: ApplicationsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Application>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: ApplicationCreateRequestToJSON(
          requestParameters["applicationCreateRequest"],
        ),
      },
      initOverrides,
    );
   ...
   * Submit new application
   */
  async applicationsPost(
    requestParameters: ApplicationsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Application> {
    const response = await this.applicationsPostRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
