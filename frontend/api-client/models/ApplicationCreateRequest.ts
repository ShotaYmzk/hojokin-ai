...
export type ApplicationCreateRequestStatusEnum =
  (typeof ApplicationCreateRequestStatusEnum)[keyof typeof ApplicationCreateRequestStatusEnum];

/**
 * Check if a given object implements the ApplicationCreateRequest interface.
 */
export function instanceOfApplicationCreateRequest(
  value: object,
): value is ApplicationCreateRequest {
...
export function ApplicationCreateRequestToJSONTyped(
  value?: ApplicationCreateRequest | null,
