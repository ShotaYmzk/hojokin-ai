 ...
 */
export function instanceOfGeneratedSection(value: object): value is GeneratedSection {
    return true;
}
...
export function GeneratedSectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): GeneratedSection {
    if (json == null) {
        return json;
    }
    return {
...
export function GeneratedSectionToJSONTyped(value?: GeneratedSection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
